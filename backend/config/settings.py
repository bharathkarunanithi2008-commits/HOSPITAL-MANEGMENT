...
SECRET_KEY = os.environ.get('SECRET_KEY', 'insecure-django-dev-key-change-in-production')
...
# Database configuration: PostgreSQL with fallback to SQLite for portable execution
